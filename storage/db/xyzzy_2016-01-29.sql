...
# Database: xyzzy
# Generation Time: 2016-01-29 5:06:55 pm +0000
# ************************************************************
...
INSERT INTO `black_cards` (`id`, `text`, `draw`, `pick`, `watermark`)
VALUES
	...
	(93,'What\'s the next superhero/sidekick duo?',0,2,NULL),
	(509,'Keith Richards enjoys ____ on his food.',0,1,'RS'),
	(1032,'Daddy, why is Mommy crying?',0,1,NULL),
	...
	(91,'Maybe she\'s born with it. Maybe it\'s ____.',0,1,NULL),
	(94,'In L.A. County Jail, word is you can trade 200 cigarettes for ____.',0,1,NULL),
	(95,'After the earthquake, Sean Penn brought ____ to the people of Haiti.',0,1,NULL),
	(96,'Next on ESPN2, the World Series of ____.',0,1,NULL),
	(97,'Step 1: ____. Step 2: ____. Step 3: Profit.',0,2,NULL),
	(98,'Life for American Indians was forever changed when the White Man introduced them to ____.',0,1,NULL),
	...
	(17,'What\'s the next Happy Meal&reg; toy?',0,1,NULL),
	...
	(87,'Lifetime&reg; presents ____, the story of ____.',0,2,NULL),
	(92,'Dear Abby,<br><br>I\'m having some trouble with ____ and would like your advice.',0,1,NULL),
	...
	(100206,'How did I lose my virginity?',0,1,NULL),
	(100207,'Here is the church<br>Here is the steeple<br>Open the doors<br>And there is ____.',0,1,NULL),
	(100208,'During his childhood, Salvador Dal&iacute; produced hundreds of paintings of ____.',0,1,NULL),
	(6,'This is the way the world ends \\ This is the way the world ends \\ Not with a bang but with ____.',0,1,NULL),
	(100209,'In 1,000 years, when paper money is a distant memory, how will we pay for goods and services?',0,1,NULL),
	(34,'War!<br><br>What is it good for?',0,1,NULL),
	(100210,'What don\'t you want to find in your Kung Pao chicken?',0,1,NULL),
	(84,'Rumor has it that Vladimir Putin\'s favorite delicacy is ____ stuffed with ____.',0,2,NULL),
	(100217,'The Smithsonian Museum of Natural History has just opened an exhibit on ____.',0,1,NULL),
	...
	(100298,'The most controversial game at PAX this year is an 8-bit indie platformer about ____.<span class=\"cardnum\">38 / 44</span>',0,1,'13PAX'),
	(100299,'What made Spock cry?<span class=\"cardnum\">39 / 44</span>',0,1,'13PAX'),
	(100300,'____: Achievement unlocked.<span class=\"cardnum\">40 / 44</span>',0,1,'13PAX'),
	(100304,'What\'s the latest bullshit that\'s troubling this quaint fantasy town?<span class=\"cardnum\">43 / 44</span>',0,1,'13PAX'),
	...
	(100301,'There was a riot at the Gearbox panel when they gave the attendees ____.<span class=\"cardnum\">41 / 44</span>',0,1,'13PAX'),
	(100302,'In the new DLC for Mass Effect, Shepard must save the galaxy from ____.<span class=\"cardnum\">42 / 44</span>',0,1,'13PAX'),
	(100303,'No Enforcer wants to manage the panel on ____.<span class=\"cardnum\">44 / 44</span>',0,1,'13PAX'),
	...
	(100390,'You\'ve seen the bearded lady!<br/>You\'ve seen the ring of fire!<br/>Now, ladies and gentlemen, feast your eyes upon ____!',0,1,'X4'),
	(100392,'She\'s up all night for good fun.<br/>I\'m up all night for ____.',0,1,'X4'),
	(100394,'Dear Leader Kim Jong-un,<br/>our village praises your infinite wisdom with a humble offering of ____.',0,1,'X4'),
	...
	(100385,'In the beginning, there was ____.<br/>And the Lord said, \"Let there be ____.\"',0,2,'X4'),
	...
	(100412,'Adventure.<br/>Romance.<br/>____.<br/><br/>From Paramount Pictures, \"____.\"',0,2,'X4'),
	...
	(100441,'GREETINGS HUMANS<br><br>I AM ____ BOT<br><br>EXECUTING PROGRAM',0,1,'HBS'),
	...
	(5211,'Ironic ____ is still ____.<br><br>(same in both blanks)',0,1,'Vidya'),
	(8813,'____ ____ Divided By ____.',2,3,'FiM1'),
	(8814,'____ <br>~Skeeter The Lurker',0,1,'FiM1'),
	...
	(8962,'What I made: ____.<br>What the DM saw: ____.<br>What I played: ____',2,3,'/tg/'),
	...
	(100458,'Revealed:<br>Why He Really Resigned!<br>Pope Benedict\'s Secret Struggle with ____!',0,1,'HBS'),
	(100459,'Here\'s what you can expect for the new year.<br>Out: ____.<br>In: ____.',0,2,'HBS'),
	...
	(9085,'It\'s fun to mentally replace the word ____ with ____.',0,2,'xkcd'),
	(100489,'Next on GSN: \"The $100,000 ____.\"',0,1,'SG'),
	(100490,'Much ____. So ____. Wow.',0,2,'SG'),
	(100514,'Siskel and Ebert have panned ____ as \"poorly conceived\" and \"sloppily executed.\"',0,1,'90s'),
	(100515,'Up next on Nickelodeon: \"Clarissa Explains ____.\"',0,1,'90s'),
	(100517,'How did Stella get her groove back?',0,1,'90s'),
	(100518,'Believe it or not, Jim Carrey can do a dead-on impression of ____.',0,1,'90s'),
	(100519,'It\'s Morphin\' Time! Mastadon! Pterodactyl! Triceratops! Sabertooth Tiger! ____!',0,1,'90s'),
	(100520,'Tonight on SNICK: \"Are You Afraid of ____?\"',0,1,'90s'),
	(100558,'What the hell?! They added a 6/6 with flying, trample, and ____.<span class=\"cardnum\">26 / 27</span>',0,1,'14PAX'),
	(100516,'I\'m a bitch, I\'m a lover, I\'m a child, I\'m ____.',0,1,'90s'),
	(100529,'____ was totally worth the trauma.<span class=\"cardnum\">9 / 10</span>',0,1,'Panel'),
	(100530,'Let me tell you about my new startup. It\'s basically ____, but for ____.<span class=\"cardnum\">10 / 10</span>',0,2,'Panel'),
	(100555,'Unfortunately, Neo, no one can be <i>told</i> what ____ is. You have to see it for yourself.<span class=\"cardnum\">23 / 27</span>',0,1,'14PAX'),
	(100556,'<i>(Heavy breathing)</i><br/>Luke, I am ____.<span class=\"cardnum\">24 / 27</span>',0,1,'14PAX'),
	(100557,'You think you have defeated me? Well, let\'s see how you handle ____!<span class=\"cardnum\">25 / 27</span>',0,1,'14PAX'),
	(100559,'____ is way better in ____ mode.<span class=\"cardnum\">27 / 27</span>',0,2,'14PAX'),
	(100563,'Nickelodeon\'s next kids\' game show is \"____\", hosted by ____.',0,2,'SG'),
	(100564,'____ probably tastes better than Quiznos.',0,1,'SG'),
	(100565,'The Discovery Channel presents: ____ week.',0,1,'PANEL'),
	(100566,'Like ____, State Farm is there.',0,1,'PANEL'),
	(100567,'The Discovery Channel presents: ____ week.<span class=\"cardnum\">10 / 10</span>',0,1,'PANEL'),
	(100568,'Like ____, State Farm is there.<span class=\"cardnum\">9 / 10</span>',0,1,'PANEL'),
	(100569,'Bob Ross\'s little-known first show was called \"The Joy of ____.\"<span class=\"cardnum\">8 / 10</span>',0,1,'PANEL'),
	(100570,'During my first game of D&amp;D, I accidentally summoned ____.<span class=\"cardnum\">7 / 10</span>',0,1,'PANEL'),
	(100571,'Buzzfeed presents: 10 pictures of ____ that look like ____.<span class=\"cardnum\">6 / 10</span>',0,2,'PANEL'),
...
INSERT INTO `card_set` (`id`, `active`, `name`, `base_deck`, `description`, `weight`)
VALUES
	(100017,1,'[C] SocialGamer',0,'Custom cards from the SocialGamer.net community.',101),
	(100157,1,'[C] Northernlion',0,'http://www.youtube.com/user/Northernlion',502),
	(100160,1,'[C] Ridiculously Stupid',0,'',504),
	(100161,1,'[C] That Guy With The Glasses',1,'http://thatguywiththeglasses.com/',503),
	(100219,1,'[C] Golby Fan Club',0,'',505),
	...
	(100224,1,'[C] Anime',1,'http://www.desudesbrigade.com/',506),
	...
	(100229,1,'[C] Vidya',0,'by Sl0nderman',517),
	(100231,1,'[C] Game Grumps',0,'',518),
	(100257,1,'Box Expansion',0,'The Expansion Box Box Expansion.',18),
	(100002,1,'[C] Very Serious',0,'http://forum.verysrs.com/',501),
	(100003,1,'[C] Admin\'s Picks',0,'Custom cards that I think are particularly fitting.',100),
	(100232,1,'[C] Rooster Teeth',0,'',519),
	(100233,1,'[C] Derps Against Humanity',0,'',520),
	(100312,1,'PAX Prime 2013',0,'PAX Prime 2013',33),
	(100415,1,'The Fourth Expansion',0,'The official Fourth Expansion.',13),
	(100236,1,'[C] Antisocial Injustice',0,'',521),
	(100422,1,'2013 Holiday Bullshit',0,'http://www.holidaybullshit.com/',23),
	(100453,1,'Polish Translation [Needs Review]',1,'I need somebody to examine this set on /viewcards.jsp and ensure that I didn\'t screw up the character encoding.',50),
	(100444,1,'[C] FiMFiction.net',0,'For FiMFiction.net users, by Cola_Bubble_Gum.',500),
	(100234,1,'[C] Anime Expansion #1',0,'http://www.desudesbrigade.com/',507),
	(100443,1,'[C] Imgur',0,'',522),
	(100445,1,'[C] /tg/',0,'/tg/',523),
	(100447,1,'[C] RagingPsyfag\'s Pack of Shenanigans',0,'',525),
	(100448,1,'[C] Cards Against Homestuck',0,'',526),
	(100449,1,'[C] Doctor Who',0,'',527),
	(100450,1,'[C] Khaos WolfKat',0,'',528),
	(100451,1,'[C] RPAnons',0,'',529),
	(100452,1,'[C] Eurovision Song Contest',0,'',530),
	(100001,1,'[C] Cards Against Equinity',0,'My Little Pony themed expansion from the reddit MLP communities.',499),
	(100446,1,'[C] xkcd',0,'',524),
	(100485,1,'House of Cards Against Humanity',0,'House of Cards pack. http://www.houseofcardsagainsthumanity.com/',40),
	(100560,1,'PAX East 2014',0,'The \"oatmeal\" cards from PAX East 2014.',34),
	(100532,1,'PAX East 2014 Panel Pack',0,'These cards were proposed during the CAH panel at PAX East 2014, printed up overnight, and distributed to panel attendees the next day.',35),
	(100531,1,'90s Nostalgia Pack',0,'',19);

/*!40000 ALTER TABLE `card_set` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table card_set_black_card
# ------------------------------------------------------------
...
LOCK TABLES `card_set_black_card` WRITE;
/*!40000 ALTER TABLE `card_set_black_card` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `card_set_black_card` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table card_set_white_card
# ------------------------------------------------------------
...
LOCK TABLES `card_set_white_card` WRITE;
/*!40000 ALTER TABLE `card_set_white_card` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `card_set_white_card` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table card_sets
# ------------------------------------------------------------
...
INSERT INTO `card_sets` (`id`, `name`, `description`, `watermark`)
VALUES
	(190,'First Version','The original version of the Cards Against Humanity base game.',NULL),
	(191,'2012 Holiday Pack','The 2012 Holiday Pack.','&#x2744;'),
	(192,'[C] /tg/','/tg/','/tg/'),
	(195,'PAX Prime 2013','PAX Prime 2013','13PAX'),
	(196,'PAX East 2014','The \"oatmeal\" cards from PAX East 2014.','14PAX'),
	(197,'90s Nostalgia Pack','','90s'),
	(198,'[C] Antisocial Injustice','','AI'),
	(199,'[C] Anime','http://www.desudesbrigade.com/','AN'),
	(200,'[C] Anime','http://www.desudesbrigade.com/','AN:HG'),
	(201,'[C] Anime Expansion #1','http://www.desudesbrigade.com/','ANX1'),
	(202,'Misprint Replacement Bonus Cards','Bonus cards included with replacements for misprinted cards.','B'),
	(203,'Box Expansion','The Expansion Box Box Expansion.','BOX'),
	(204,'[C] Cards Against Equinity','My Little Pony themed expansion from the reddit MLP communities.','CAE'),
	(205,'Canadian','Cards included in Canadian orders.','CAN'),
	(206,'[C] Derps Against Humanity','','DAH'),
	(207,'[C] Doctor Who','','DW'),
	(208,'[C] Eurovision Song Contest','','ESC'),
	(209,'[C] FiMFiction.net','For FiMFiction.net users, by Cola_Bubble_Gum.','FiM1'),
	(210,'[C] Sodomy Dog\'s Furry Pack','','Furry'),
	(211,'[C] Golby Fan Club','','GFC'),
	(212,'[C] Game Grumps','','GG'),
	(213,'2013 Holiday Bullshit','http://www.holidaybullshit.com/','HBS'),
	(214,'House of Cards Against Humanity','House of Cards pack. http://www.houseofcardsagainsthumanity.com/','HOCAH'),
	(215,'[C] Imgur','','Imgur'),
	(216,'[C] Khaos WolfKat','','KHAOS'),
	(217,'[C] Mr. Man Collection','','MrMan'),
	(218,'[C] Cards Against Homestuck','','MSPA'),
	(219,'[C] Northernlion','http://www.youtube.com/user/Northernlion','NL'),
	(220,'PAX East 2014 Panel Pack','These cards were proposed during the CAH panel at PAX East 2014, printed up overnight, and distributed to panel attendees the next day.','Panel'),
	(221,'PAX East 2013 Pack &quot;A&quot;','PAX East 2013 Pack &quot;A&quot;.','PAX A'),
	(222,'PAX East 2013 Pack &quot;B&quot;','PAX East 2013 Pack &quot;B&quot;.','PAX B'),
	(223,'PAX East 2013 Pack &quot;C&quot;','PAX East 2013 Pack &quot;C&quot;.','PAX C'),
	(224,'Polish Translation [Needs Review]','I need somebody to examine this set on /viewcards.jsp and ensure that I didn\'t screw up the character encoding.','Pol'),
	(225,'[C] RPAnons','','RP'),
	(226,'[C] RagingPsyfag\'s Pack of Shenanigans','','RPF'),
	(227,'[C] Ridiculously Stupid','','RS'),
	(228,'[C] Rooster Teeth','','RT'),
	(229,'[C] SocialGamer','Custom cards from the SocialGamer.net community.','SG'),
	(230,'[C] That Guy With The Glasses','http://thatguywiththeglasses.com/','TGWTG'),
	(231,'[C] Vidya','by Sl0nderman','Vidya'),
	(232,'[C] Vidya','by Sl0nderman','Viyda'),
	(233,'[C] Very Serious','http://forum.verysrs.com/','VS'),
	(234,'The First Expansion','The official First Expansion.','X1'),
	(235,'The Second Expansion','The official Second Expansion.','X2'),
	(236,'The Third Expansion','The official Third Expansion.','X3'),
	(237,'The Fourth Expansion','The official Fourth Expansion.','X4'),
	(238,'[C] xkcd','','xkcd');
...
VALUES
	...
	(462,'MechaHitler.',NULL),
	(463,'Getting naked and watching Nickelodeon.',NULL),
	(464,'Charisma.',NULL),
	(465,'Morgan Freeman\'s voice.',NULL),
	(466,'Breaking out into song and dance.',NULL),
	(467,'Soup that is too hot.',NULL),
	(468,'Chutzpah.',NULL),
	(469,'Unfathomable stupidity.',NULL),
	(470,'Horrifying laser hair removal accidents.',NULL),
	(471,'Boogers.',NULL),
	(3664,'The shitty remains of Taco Bell&reg;.','RS'),
	(473,'Expecting a burp and vomiting on the floor.',NULL),
	(474,'A defective condom.',NULL),
	(475,'Teenage pregnancy.',NULL),
	(476,'Hot cheese.',NULL),
	(477,'A mopey zoo lion.',NULL),
	(478,'Shapeshifters.',NULL),
	(479,'The Care Bear Stare.',NULL),
	(480,'Erectile dysfunction.',NULL),
	(481,'The chronic.',NULL),
	(484,'Firing a rifle into the air while balls deep in a squealing hog.',NULL),
	(485,'Nicolas Cage.',NULL),
	...
	(488,'A gentle caress of the inner thigh.',NULL),
	(489,'Poor life choices.',NULL),
	(490,'Embryonic stem cells.',NULL),
	(491,'Customer service representatives.',NULL),
	(492,'The Little Engine That Could.',NULL),
	(493,'Lady Gaga.',NULL),
	(494,'A death ray.',NULL),
	(495,'Vigilante justice.',NULL),
	(496,'Exactly what you\'d expect.',NULL),
	(497,'Natural male enhancement.',NULL),
	(498,'Passive-aggressive Post-it notes.',NULL),
	(499,'Inappropriate yodeling.',NULL),
	(500,'A homoerotic volleyball montage.',NULL),
	(501,'Actually taking candy from a baby.',NULL),
	(502,'Jibber-jabber.',NULL),
	(503,'Crystal meth.',NULL),
	(504,'My inner demons.',NULL),
	(505,'Pac-Man uncontrollably guzzling cum.',NULL),
	(506,'My vagina.',NULL),
	(3670,'Sonic brutally murdering Mario.','RS'),
	(508,'The true meaning of Christmas.',NULL),
	...
	(1034,'A bitch slap.',NULL),
	(1035,'One trillion dollars.',NULL),
	(1036,'Chunks of dead prostitute.',NULL),
	(1037,'The entire Mormon Tabernacle Choir.',NULL),
	(1038,'The female orgasm.',NULL),
	(1039,'Extremely tight pants.',NULL),
	(1040,'Stormtroopers.',NULL),
	(1041,'The Boy Scouts of America.',NULL),
	(1042,'Throwing a virgin into a volcano.',NULL),
	(3676,'The Bible.','RS'),
	...
	(145,'Five-Dollar Footlongs&trade;.',NULL),
	(100011,'Dr. Phil.','SG'),
	...
	(167,'The Tempur-Pedic&reg; Swedish Sleep System&trade;.',NULL),
	(192,'Fancy Feast&reg;.',NULL),
	(229,'Hot Pockets&reg;.',NULL),
	(267,'Domino\'s&trade; Oreo&trade; Dessert Pizza.',NULL),
	(284,'The &Uuml;bermensch.',NULL),
	(311,'Adderall&trade;.',NULL),
	(354,'GoGurt&reg;.',NULL),
	(404,'A Super Soaker&trade; full of cat pee.',NULL),
	(440,'Lunchables&trade;.',NULL),
	(460,'The Make-A-Wish&reg; Foundation.',NULL),
	(472,'A Bop It&trade;.',NULL),
	(482,'Home video of Oprah sobbing into a Lean Cuisine&reg;.',NULL),
	(486,'Euphoria&trade; by Calvin Klein.',NULL),
	(487,'Switching to Geico&reg;.',NULL),
	(507,'The Donald Trump Seal of Approval&trade;.',NULL),
	...
	(100164,'Advice from a wise, old black man.',NULL),
	(99999999,'The homosexual lifestyle.',NULL),
	(100165,'The Devil himself.',NULL),
	(100166,'The art of seduction.',NULL),
	(100167,'Funky fresh rhymes.',NULL),
	(100168,'The light of a billion suns.',NULL),
	(10013,'A tub of Vaseline.','Furry'),
	(100170,'Destroying the evidence.',NULL),
	(10014,'Sex with strangers.','Furry'),
	(100172,'Silence.',NULL),
	(100173,'Growing a pair.',NULL),
	(100174,'Synergistic management solutions.',NULL),
	(100175,'Wet dreams.',NULL),
	(100176,'A live studio audience.',NULL),
	(100177,'The Great Depression.',NULL),
	(100178,'An M16 assault rifle.',NULL),
	(100179,'Poopy diapers.',NULL),
	(100180,'Tickling Sean Hannity, even after he tells you to stop.',NULL),
	(100181,'Stalin.',NULL),
	(100182,'A spastic nerd.',NULL),
	(100183,'Rush Limbaugh\'s soft, shitty body.',NULL),
	(100184,'Capturing Newt Gingrich and forcing him to dance in a monkey suit.',NULL),
	(100185,'Battlefield amputations.',NULL),
	(100186,'Brown people.',NULL),
	(100187,'Rehab.',NULL),
	(100188,'An ugly face.',NULL),
	(100189,'Menstrual rage.',NULL),
	(100190,'An uppercut.',NULL),
	(100191,'Shiny objects.',NULL),
	(100192,'50,000 volts straight to the nipples.',NULL),
	(100193,'A bucket of fish heads.',NULL),
	(100194,'Hospice care.',NULL),
	(100195,'Being fat and stupid.',NULL),
	(100196,'Getting married, having a few kids, buying some stuff, retiring to Florida, and dying.',NULL),
	(100197,'A pyramid of severed heads.',NULL),
	(100198,'Crucifixion.',NULL),
	(100199,'A subscription to Men\'s Fitness.',NULL),
	(100200,'Some god-damn peace and quiet.',NULL),
	(100201,'A micropig wearing a tiny raincoat and booties.',NULL),
	(100202,'Used panties.',NULL),
	(100204,'The penny whistle solo from \"My Heart Will Go On.\"',NULL),
	(100205,'A tribe of warrior women.',NULL),
	(100212,'An oversized lollipop.',NULL),
	(100213,'Helplessly giggling at the mention of Hutus and Tutsis.',NULL),
	(100214,'Not wearing pants.',NULL),
	(100215,'Consensual sex.',NULL),
	(100216,'Her Majesty, Queen Elizabeth II.',NULL),
	...
	(100270,'Reading the comments.<span class=\"cardnum\">3 / 44</span>','13PAX'),
	(100275,'The collective wail of every Magic player suddenly realizing that they\'ve spent hundreds of dollars on pieces of cardboard.<span class=\"cardnum\">8 / 44</span>','13PAX'),
	(100276,'Being an attractive elf trapped in an unattractive human\'s body.<span class=\"cardnum\">9 / 44</span>','13PAX'),
	(100277,'Temporary invincibility.<span class=\"cardnum\">10 / 44</span>','13PAX'),
	(100281,'Mario Kart rage.<span class=\"cardnum\">14 / 44</span>','13PAX'),
	(100287,'A homemade, cum-stained Star Trek uniform.<span class=\"cardnum\">20 / 44</span>','13PAX'),
	(100290,'Never watching, discussing, or thinking about My Little Pony.<span class=\"cardnum\">23 / 44</span>','13PAX'),
	(100291,'Turn-of-the-century sky racists.<span class=\"cardnum\">24 / 44</span>','13PAX'),
	(100293,'A fully-dressed female videogame character.<span class=\"cardnum\">26 / 44</span>','13PAX'),
	(100294,'Buying virtual clothes for a Sim family instead of real clothes for a real family.<span class=\"cardnum\">27 / 44</span>','13PAX'),
	(100295,'Google Glass + e-cigarette: Ultimate Combo!<span class=\"cardnum\">28 / 44</span>','13PAX'),
	...
	(100268,'Full HD.<span class=\"cardnum\">1 / 44</span>','13PAX'),
	(100272,'Allowing nacho cheese to curdle in your beard while you creep in League of Legends.<span class=\"cardnum\">5 / 44</span>','13PAX'),
	(100278,'The Sarlacc.<span class=\"cardnum\">11 / 44</span>','13PAX'),
	(100282,'Nude-modding Super Mario World.<span class=\"cardnum\">15 / 44</span>','13PAX'),
	(100283,'An angry stone head that stomps on the floor every three seconds.<span class=\"cardnum\">16 / 44</span>','13PAX'),
	(100284,'Yoshi\'s huge egg-laying cloaca.<span class=\"cardnum\">17 / 44</span>','13PAX'),
	(100285,'The Cock Ring of Alacrity.<span class=\"cardnum\">18 / 44</span>','13PAX'),
	(100286,'Offering sexual favors for an ore and a sheep.<span class=\"cardnum\">19 / 44</span>','13PAX'),
	(100288,'Unlocking a new sex position.<span class=\"cardnum\">21 / 44</span>','13PAX'),
	(100289,'The boner hatch in the Iron Man suit.<span class=\"cardnum\">22 / 44</span>','13PAX'),
	(100292,'The decade of legal inquests following a single hour of Grand Theft Auto.<span class=\"cardnum\">25 / 44</span>','13PAX'),
	(100296,'Legendary Creature &ndash; Robert Khoo.<span class=\"cardnum\">31 / 44</span>','13PAX'),
	(100297,'Winning the approval of Cooking Mama that you never got from actual mama.<span class=\"cardnum\">32 / 44</span>','13PAX'),
	(100305,'Tapping Sara Angel.<span class=\"cardnum\">29 / 44</span>','13PAX'),
	(100306,'Charles Barkley Shut Up and Jam!<span class=\"cardnum\">30 / 44</span>','13PAX'),
	(100307,'Getting into a situation with an owlbear.<span class=\"cardnum\">34 / 44</span>','13PAX'),
	(100308,'Grand Theft Auto: Fort Lauderdale.<span class=\"cardnum\">35 / 44</span>','13PAX'),
	(100309,'A madman who lives in a policebox and kidnaps women.<span class=\"cardnum\">36 / 44</span>','13PAX'),
	(100310,'SNES cartridge cleaning fluid.<span class=\"cardnum\">37 / 44</span>','13PAX'),
	(100311,'Eating a pizza that\'s lying on the street to gain health.<span class=\"cardnum\">33 / 44</span>','13PAX'),
	...
	(100261,'Filling every pouch of a UtiliKilt&trade; with pizza. (12/44)','PAX'),
	(100262,'Bowser\'s aching heart. (13/44)','PAX'),
	(100264,'Turn-of-the-century sky racists. (24/44)','PAX'),
	(100269,'The gravity gun.<span class=\"cardnum\">2 / 44</span>','13PAX'),
	(100273,'Achieving the manual dexterity and tactical brilliance of a 12-year-old Korean boy.<span class=\"cardnum\">6 / 44</span>','13PAX'),
	(100274,'Rolling a D20 to save a failing marriage.<span class=\"cardnum\">7 / 44</span>','13PAX'),
	...
	(3059,'Lara Croft.','NL'),
	(100280,'Bowser\'s aching heart.<span class=\"cardnum\">13 / 44</span>','13PAX'),
	(3768,'Scotsmen marrying their sheep.','RS'),
	(100279,'Filling every pouch of a UtiliKilt&trade; with pizza.<span class=\"cardnum\">12 / 44</span>','13PAX'),
	(100313,'Quiznos.','SG'),
	(100271,'70,000 gamers sweating and farting inside an airtight steel dome.<span class=\"cardnum\">4 / 44</span>','13PAX'),
	...
	(100375,'Prince Ali,<br/>fabulous he,<br/>Ali Ababwa.','X4'),
	...
	(100367,'Whatever a McRib&reg; is made of.','X4'),
	(100368,'Africa.','X4'),
	(100370,'Khakis.','X4'),
	(100371,'A gender identity that can only be conveyed through slam poetry.','X4'),
	(100372,'Stuff a child\'s face with Fun Dip&reg; until he starts having fun.','X4'),
	...
	(100486,'A fountain of vomit.','SG'),
	(100487,'Billy the Answer Head.','SG'),
	(100488,'Performing the Secret Slime Action.','SG'),
	(100491,'Sucking the President\'s dick.','90s'),
	(100492,'Sunny D! Alright!','90s'),
	(100494,'Log&trade;.','90s'),
	(100498,'Wearing Nicolas Cage\'s face.','90s'),
	(100499,'Stabbing the shit out of a Capri Sun.','90s'),
	(100501,'Freeing Willy.','90s'),
	(100502,'Liking big butts and not being able to lie about it.','90s'),
	(100503,'The Great Cornholio.','90s'),
	(100504,'Pure Moods, Vol. 1.','90s'),
	(100524,'Hodor.<span class=\"cardnum\">4 / 10</span>','Panel'),
	(100525,'A floor that is literally made of lava.<span class=\"cardnum\">5 / 10</span>','Panel'),
	...
	(100493,'A mulatto, an albino, a mosquito, and my libido.','90s'),
	(100495,'Jerking off to a 10-second RealMedia clip.','90s'),
	(100505,'Yelling \"girl power!\" and doing a high kick.','90s'),
	(100506,'Pamela Anderson\'s boobs running in slow motion.','90s'),
	(100509,'Getting caught up in the CROSSFIRE&trade;.','90s'),
	(100528,'Exciting content!<span class=\"cardnum\">8 / 10</span>','Panel'),
	(100533,'Collecting all seven power crystals.<span class=\"cardnum\">1 / 27</span>','14PAX'),
	(100536,'Demons and shit.<span class=\"cardnum\">4 / 27</span>','14PAX'),
	(100537,'The imagination of Peter Jackson.<span class=\"cardnum\">5 / 27</span>','14PAX'),
	(100538,'Futuristic death sports.<span class=\"cardnum\">6 / 27</span>','14PAX'),
	(100539,'KHAAAAAAAAAN!<span class=\"cardnum\">7 / 27</span>','14PAX'),
	(100540,'The Star Wars Universe.<span class=\"cardnum\">8 / 27</span>','14PAX'),
	(100541,'Taking 2d6 emotional damage.<span class=\"cardnum\">9 / 27</span>','14PAX'),
	(100542,'A grumpy old Harrison Ford who\'d rather be doing anything else.<span class=\"cardnum\">10 / 27</span>','14PAX'),
	(100543,'All of the good times and premium gaming entertainment available to you in the Kickstarter room.<span class=\"cardnum\">11 / 27</span>','14PAX'),
	(100455,'Congress\'s flaccid penises withering away beneath their suit pants.','HBS'),
	(100462,'A homoerotic subplot.','HOCAH'),
	(100496,'Deregulating the mortgage market.','90s'),
	(100497,'The Y2K bug.','90s'),
	(100500,'Kurt Cobain\'s death.','90s'),
	(100507,'Pizza in the morning, pizza in the evening, pizza at supper time.','90s'),
	(100508,'Angels interfering in an otherwise fair baseball game.','90s'),
	(100510,'Patti Mayonnaise.','90s'),
	(100511,'Cool 90s up-in-the-front hair.','90s'),
	(100512,'Several Michael Keatons.','90s'),
	(100513,'A bus that will explode if it goes under 50 miles per hour.','90s'),
	(100521,'Stepping on a god damn friggin\' LEGO.<span class=\"cardnum\">1 / 10</span>','Panel'),
	(100522,'Rubbing chocolate pudding all over Bill Cosby\'s nipples.<span class=\"cardnum\">2 / 10</span>','Panel'),
	(100523,'What The Rock was really cooking.<span class=\"cardnum\">3 / 10</span>','Panel'),
	(100526,'All this liquid in my mouth.<span class=\"cardnum\">6 / 10</span>','Panel'),
	(100527,'Giving a dolphin a handjob for science.<span class=\"cardnum\">7 / 10</span>','Panel'),
	(100544,'Attacking from Kamchatka.<span class=\"cardnum\">12 / 27</span>','14PAX'),
	(100545,'Separate drinking fountains for dark elves.<span class=\"cardnum\">13 / 27</span>','14PAX'),
	(100546,'Lagging out.<span class=\"cardnum\">14 / 27</span>','14PAX'),
	(100548,'Mistakenly hitting on a <i>League of Legends</i> statue.<span class=\"cardnum\">16 / 27</span>','14PAX'),
	...
	(100534,'Whatever <i>Final Fantasy</i> bullshit happened this year.<span class=\"cardnum\">2 / 27</span>','14PAX'),
	(100535,'Endless ninjas.<span class=\"cardnum\">3 / 27</span>','14PAX'),
	(100547,'Getting bitten by a radioactive spider and then battling leukemia for 30 years.<span class=\"cardnum\">15 / 27</span>','14PAX'),
	(100552,'A giant mechanical bird with a tragic backstory.<span class=\"cardnum\">20 / 27</span>','14PAX'),
	(100553,'The pure, Zen-like state that exists between micro and macro.<span class=\"cardnum\">21 / 27</span>','14PAX'),
	...
	(100549,'Ser Jorah Mormont\'s cerulean-blue balls.<span class=\"cardnum\">17 / 27</span>','14PAX'),
	(100550,'The old gods.<span class=\"cardnum\">18 / 27</span>','14PAX'),
	(100551,'Stuffing my balls into a Sega Genesis and pressing the power button.<span class=\"cardnum\">19 / 27</span>','14PAX'),
	(100468,'Getting eaten out while on the phone with Dad.','HOCAH'),
	(100469,'Making it look like a suicide.','HOCAH'),
	(100554,'Xena,<br/>Warrior Princess.<span class=\"cardnum\">22 / 27</span>','14PAX'),
	(100561,'Blank.','SG'),
	(100471,'An older man.','HOCAH'),
	(100572,'No survivors.<span class=\"cardnum\">5 / 10</span>','PANEL'),
	(100573,'The beautiful sport of Turkish oil wrestling.<span class=\"cardnum\">4 / 10</span>','PANEL'),
	(100574,'Pooping as quietly as possible.<span class=\"cardnum\">3 / 10</span>','PANEL'),
	(100575,'Pelvic sorcery.<span class=\"cardnum\">2 / 10</span>','PANEL'),
	(100576,'A neck beard that is 10% cheese.<span class=\"cardnum\">1 / 10</span>','PANEL'),
	...
	(21840,'Wzwód trwajcy ponad 4 godziny.','Pol'),
	...
	(21850,'Fundacja Polsat dzieci.','Pol'),
	...
	(21908,'Pac-man tryskajcy sperm w amoku.','Pol'),
	...
	(22008,'Murzyni.','Pol'),
	(22010,'Suki.','Pol'),
	(22012,'Chwytajce za serce sierotki.','Pol'),
	...
	(22057,'Amputacja.','Pol'),
	(22058,'Status mojego zwizku.','Pol'),
	...
	(22096,'Obciganie w czasie jazdy autem.','Pol'),
	(22098,'Mazurek.','Pol'),
	(22099,'Zaspany lew w zoo.','Pol'),
	(22100,'Paczka magicznych fasolek.','Pol'),
	(22104,'Wybuch termo jdrowy.','Pol'),
	(22106,'Donald Tusk.','Pol'),
	(22108,'Zabawa w wampira podczas miesiczki.','Pol'),
	(22109,'Wielki wybuch.','Pol'),
	(22110,'Miny ldowe.','Pol'),
